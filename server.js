...
app.get('/api', (req, res) => {
  ...
  res.json({
    ...
    endpoints: [
      ...
      {method: 'GET', path: '/api/test', description: 'test api'},
      {method: 'GET', path: '/api/helloworld/', description: 'hello world'},
...
app.get('/api/profile', (req, res) => {
  res.json({
    'name': 'Rob',
    'homeCountry': 'Germany',
    'degreeProgram': 'Mathematics in Data Science',//informatics or CSE.. etc
    'email': 'robin.mittas@gmx.de',
    'deployedURLLink': '',//leave this blank for the first exercise
    'apiDocumentationURL': '', //leave this also blank for the first exercise
    'currentCity': 'Munich',
    'hobbies': ['Soccer', 'Surfing', 'Climbing', 'Ski']
...
app.put('/api/books/:id', (req, res) => {
   ...
   */
  db.books.findByIdAndUpdate({_id: bookId}, bookNewData, {useFindAndModify:false, new:true} , (err, doc) => {
    if (err) {
...
app.delete('/api/books/:id', (req, res) => {
   ...
   */
  db.books.findByIdAndDelete({_id: bookId}, (err, doc) => {
    if (err) {
      console.log("Something went wrong when deleting data")
    }
    console.log(doc)
  });
  var deletedBook = req.body;
